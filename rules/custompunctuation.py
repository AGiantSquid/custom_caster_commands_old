...
class CustomPunctuation(MergeRule):
    ...
    mapping = {  
        ...
        "quotes":                                   R(Key("apostrophe,apostrophe,left"), rdescript="Thin Quotation Marks"),
        ...
        "left curly":                               R(Key("lbrace"), rdescript="Left Curly Brace"),
        "right curly":                              R(Key("rbrace"), rdescript="Right Curly Brace"),
