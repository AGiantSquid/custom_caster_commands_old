...
class CustomSublimeCommands(MergeRule):
    ...
    mapping = {  
        ...
        "spring <n>":                                 R(Key("c-g") + Pause("10") + Text("%(n)s") + Key("enter"), rdescript="Sublime: Go to Line #"),
        "crew [<text>]":                                 R(Key("c-i") + Pause("10") + Text("%(text)s") + Key("enter") + Key("escape"), rdescript="Sublime: Get Next"),
        "trail [<text>]":                                 R(Key("cs-i") + Pause("10") + Text("%(text)s") + Key("enter") + Key("escape"), rdescript="Sublime: Get Next"),
